...
$routes->group('inventarios', ['filter' => 'auth'], function ($routes) {
    ...
    // $routes->get('control-calidad/(:num)', 'inventarios\inventariosController::controlCalidad/$1', ['filter' => 'role:admin,almacen']);
...
// Rutas para la gestión de devoluciones de envios
$routes->group('devoluciones', ['filter' => 'auth'], function ($routes) {
    ...
    // $routes->get('registerDevoluciones', 'Devoluciones\DevolucionesController::register', ['filter' => 'role:admin,almacen,vendedor,ganaderia,agropecuario']);
...
$routes->group('productosagro', ['filter' => 'auth'], function ($routes) {
    ...
    // $routes->get('cierre', 'inventarios\inventariosController::exportarPdfVentas', ['filter' => 'role:admin,ganaderia,agropecuario']);
    // $routes->get('cierre/rango', 'inventarios\inventariosController::exportarPdfVentas', ['filter' => 'role:admin,ganaderia,agropecuario']);



    // $routes->get('buscar-clientes', 'inventarios\inventariosController::buscarClientes', ['filter' => 'role:admin,ganaderia,agropecuario']);
    // $routes->get('buscar-productos', 'inventarios\inventariosController::buscarProductos', ['filter' => 'role:admin,ganaderia,agropecuario']);
    // $routes->post('guardar-cliente', 'inventarios\inventariosController::guardarCliente', ['filter' => 'role:admin,ganaderia,agropecuario']);
