...
<div class="container-fluid">
    ...
    <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
          ...
          <div>
            <h4 class="mb-sm-0 text-success me-3">LÁCTEOS</h4>
  ...
  $isContabilidad = (strtolower(trim($userRoleName)) === 'contabilidad');
  ?>
    ...
    <?php if (!$isContabilidad): ?>
      <div class="col-xl-3 col-md-6">
        ...
        <?php elseif ($showCloseBoxKPI): ?>
          <a href="<?= base_url('inventarios/cierre?fecha_inicio=' . esc($fecha_desde) . '&fecha_fin=' . esc($fecha_desde)) ?>" target="_blank" class="text-decoration-none">
