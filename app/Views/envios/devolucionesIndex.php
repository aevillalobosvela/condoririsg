...
// Arrays to hold envios by status (sin observados)
$enviosPorEstado = [
  'todos' => $envios ?? [],
  'pendientes' => [],
  'transito' => [],
...
// Estado definitions (sin observado)
$estados = [
  1 => 'Pendiente',
  2 => 'En Tránsito',
  9 => 'Entregado'
  ...
  <div class="kpi-cards animate-fade-in-up">
    ...
    <div class="kpi-card transito" onclick="switchTab('transito')">
      <div class="kpi-body">
        ...
        <p class="kpi-subtitle">En ruta</p>
      </div>
      <div class="kpi-icon">
  ...
  <div class="tabs-container animate-fade-in-up">
    <div class="nav-tabs-custom">
      ...
      <button class="nav-tab" data-tab="entregados">
        Entregados <span class="tab-count"><?= $enviosEntregados ?></span>
      </button>
    </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php 
                        ...
                        $badge_class = match($estado_id) {
                          1 => 'badge-pendiente',
                          2 => 'badge-enviado',
                          9 => 'badge-entregado',
                          11 => 'badge-observado',
                          default => 'badge-enviado'
                        };
                    ...
                    <td class="text-end">
                      <div class="btn-group" role="group">
                        <a href="<?= base_url('envios/devoluciones/show/' . $envio['id']) ?>" 
                           class="btn btn-sm btn-outline-success" 
                           title="Ver Detalles">
                          <i class="ri-eye-fill"> Ver </i>
                        </a> 
                        <?php if ($envio['estado_id'] == 1): ?>
                        <a href="<?= base_url('envios/edit/' . $envio['id']) ?>" 
                           class="btn btn-sm btn-outline-primary" 
                           title="Editar">
                          <i class="ri-pencil-fill"> Editar </i>
                        </a>
                        <?php endif; ?>
                      </div>
                    </td>
                ...
                <tr>
                  <td colspan="7">
                    <div class="empty-state">
                      ...
                      <h3 class="empty-text">No hay envíos en esta categoría</h3>
                      <p class="text-muted mt-2">Los envíos aparecerán aquí cuando estén disponibles.</p>
                    </div>
                  </td>
                </tr>
              <?php endif; ?>
