...
<main class="main">
  ...
  <section class="kpis">
    <div class="card kpi">
      ...
      <div class="sub">
        <span class="trend up"><i class="mdi mdi-arrow-trend-up"></i> 3.2%</span>
    ...
    <div class="card kpi">
      ...
      <div class="sub">
        <span class="trend down"><i class="mdi mdi-arrow-trend-down"></i> 8%</span>
    ...
    <div class="card kpi">
      ...
      <div class="sub">
        ...
        <span class="trend up"><i class="mdi mdi-arrow-trend-up"></i> 8.3%</span>
        <span>vs ayer</span>
      </div>
    </div>
    ...
    <div class="card kpi">
      ...
      <div class="sub">
        <span class="trend down"><i class="mdi mdi-minus"></i> 2</span>
  ...
  <section class="quick">
    ...
    <div class="quick-grid">
      ...
      <div class="quick-item">
        <div class="qi-icon"><i class="mdi mdi-chart-simple"></i></div>
