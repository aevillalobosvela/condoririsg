        ...
        <div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb m-0">
              <li class="breadcrumb-item"><a href="<?= base_url('/') ?>"><i class="ri-home-4-line me-1"></i>Inicios</a></li>
      ...
      <div class="col-12">
        ...
        <div class="sucursales-grid">
          <?php foreach ($sucursales as $sucursal): ?>
            <a href="<?= base_url('contabilidad/show/' . $sucursal['id']) ?>"
              class="sucursal-card"
              role="button"
              tabindex="0"
              aria-label="Ir a la sucursal <?= esc($sucursal['nombre']) ?>">
