 ...
 
{
    ...
    public function index()
    {
        ...
        echo view('reportes/reportesIndex', $data);
    ...
    public function delete(int $id): RedirectResponse
    {
        if ($this->categoriaModel->delete($id)) {
            session()->setFlashdata('success', 'Categorias eliminada exitosamente (movida a la papelera).');
        } else {
            session()->setFlashdata('error', 'No se pudo eliminar la categoria.');
        }
